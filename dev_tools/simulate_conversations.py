    ...
    for idx, s in inputs:
        try:
            ...
            if hasattr(sp, "parse_input"):
                lexicon_path = (
                    "velonix_lexicon.json"
                    if os.path.exists("velonix_lexicon.json")
                    else "emotional_os/glyphs/learned_lexicon.json"
                )
                db_path = (
                    "emotional_os/glyphs/glyphs.db" if os.path.exists("emotional_os/glyphs/glyphs.db") else "glyphs.db"
                )
