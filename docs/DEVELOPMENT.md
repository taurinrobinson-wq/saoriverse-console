...
If you prefer using a system package or a different release of `actionlint`, make sure to run the
same (or a compatible) version as the CI job to avoid false positives/negatives.
