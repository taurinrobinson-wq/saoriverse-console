...
## The System: Pre-Collapse

**Before the collapse**, Corelink was a bidirectional emotional infrastructure:

- **Nodes**: Fixed beacons distributed across Velinor that broadcast and received emotional signals
- **Implants**: Neural interfaces in citizens' bodies that acted as antennae and emotional filters
...
When the core hub disconnected:

- **Nodes became isolated**: Each node kept broadcasting but lost the ability to receive signals from other nodes or the core
- **Signal became unidirectional**: Emotional broadcasts flooded outward with no feedback loop, no regulation, no rest
- **The system experienced infinite recursion**: Nodes began broadcasting their own incoherence back at themselves, amplifying distortion with each cycle
- **Implanted people became saturated**: Citizens with implants were flooded with unfiltered, unregulated emotional noise

This is why:
- People have fractured memories (cognitive overload)
- They experience disorientation and headaches near nodes (proximity to broadcast)
- They misremember or contradict each other (different nodes broadcasting conflicting emotional data)
- They feel drawn to certain places but afraid to approach (emotional echoes with no context)
...
## Coherence: The Game's Core Mechanic

**Coherence** is the state of the Corelink system. It ranges from 0 (complete fragmentation) to 7 (full restoration, one glyph per emotional domain).

### Coherence Levels

| Level | State | NPC Behavior | Signal Strength | Player Experience |
|-------|-------|--------------|-----------------|-------------------|
| 0 | **Fragmented** | Severe disorientation, fractured speech, contradictions | Chaotic, overwhelming | Heavy distortion, hallucinations feel hostile |
| 1 | **Glyph 1 cleared** | First echoes of clarity, some NPCs remember fragments | Slightly regulated | Distortions become navigable, patterns emerge |
| 2 | **Glyph 2 cleared** | NPCs begin to recognize each other's distortions | Two domains stable | Player feels signal even without implant |
| 3 | **Glyph 3 cleared** | Conversations become possible, shared memory fragments | Half-regulated | Chamber atmospheres become clearer, less chaotic |
| 4 | **Glyph 4 cleared** | NPCs remember events, ask questions | Four stable channels | Hallucinations become more symbolic |
| 5 | **Glyph 5 cleared** | Communities reform, collective memory stabilizes | Five domains coherent | System broadcasting clearly even to unimplanted |
| 6 | **Glyph 6 cleared** | NPCs begin to remember *why* things happened | Six domains restored | Chambers feel almost peaceful, distortions minimal |
| 7 | **All glyphs cleared** | Full restoration, NPCs remember the collapse and its cause | Full coherence | System broadcasts clearly, hallucinations become conversations |
...
## The Chambers: Physical Manifestation
...
## NPCs and Implants: How They're Affected

NPCs with implants experience Corelink's collapse as:

- **Cognitive saturation** — receiving emotional data with no way to filter or respond
- **Memory fragmentation** — overlapping broadcasts creating contradictory memories
- **Disorientation** — losing sense of what's real vs. what's broadcast
- **Emotional echoes** — feeling something without understanding why (it's a node broadcasting somewhere nearby)
- **Physical symptoms** — headaches, mild nausea, sense of being watched

The intensity depends on:
- **Implant strength** — some people have older implants, some newer; sensitivity varies
- **Distance to nodes** — closer = more intense distortion
- **Coherence level** — as the player restores glyphs, the signal becomes less chaotic

---

## The Player's Journey: Narrative Progression
...
The Corelink system connects to:

- **Story**: Why Velinor collapsed, why NPCs are broken, what restoration means
- **Gameplay**: Chambers, progression, difficulty curve
- **Atmosphere**: Distortion effects, hallucinations, UI feedback
