...
- **Empathetic responses** → commas (warm, connective)
...
✅ All responses generated by the app are automatically:
...
## 📈 Rotation Bank Details

Each tone pool has **15 rotation bank entries**, preventing:
- ❌ "There's no wrong way to move through this" (repeated 4+ times)
- ❌ "I hear you" (repeated every turn)
- ❌ Generic closings that feel canned
