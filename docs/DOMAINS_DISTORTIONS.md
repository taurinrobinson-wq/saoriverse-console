# Domain-to-Distortion Mapping: The Seven Glyphs
...
- The hallucination it creates (the "Triglyph boss")
- The chamber atmosphere
- How defeating it feels
- How the world changes when it's cleared
...
- **Audio**: Whispers of familiar people saying your name, getting closer, then fading. Overlapping conversations just beyond comprehension. Heartbeats that aren't your own.
...
**How to resolve it**: The player must stay close to it without fear. Not fighting—standing in its presence, accepting the longing without trying to fix it. As they do, the entity begins to cohere, to solidify. The overlapping silhouettes become a single, clear figure. It looks at the player with recognition.

**When cleared**: The chamber fills with the sound of heartbeats, synchronized and peaceful. The vast space contracts into something intimate. A single figure stands before the player—not attacking, just present.

### Post-Clear Effects (Coherence +1)
- NPCs near each other begin to remember shared moments
- Communities naturally form around hubs
- Dialogue becomes possible—people start asking each other questions
- The world feels less lonely

### Glyph Symbol
**Covenant Glyph**: Two figures touching, their outlines flowing into each other. Lines connecting them to a central node.
...
**How to resolve it**: The player must make a choice and commit to it, even though paths seem futile. Walking through a wall that looks solid. Choosing a door and refusing to turn back when it loops. Acts of faith in the face of illogic.

**When cleared**: The maze suddenly stops shifting. All paths become clear. The figure at the center—a standing, determined silhouette—turns to face the player. It nods.

### Post-Clear Effects (Coherence +2)
- NPCs move with more confidence
- People make decisions instead of standing frozen
...
**How to resolve it**: The player must find the hidden harmony—the moment when the contradiction resolves. Not by forcing the figures together, but by finding the rhythm they already share. Understanding that opposition can create symphony.

**When cleared**: The two figures stop moving in opposition. They move in harmony. Their silhouettes overlap not as contradiction but as unity.

### Post-Clear Effects (Coherence +3)
- NPCs stop contradicting each other
- Shared memories become possible
...
**How to resolve it**: The player must accept not knowing which is real and choose to act anyway. Moving forward despite doubt. Or by finding a detail that differentiates the two—proof that one is real and one isn't.

**When cleared**: The mirror figure steps aside. It's revealed to be something else—a reflection, a projection, a memory. Real or not doesn't matter anymore.

### Post-Clear Effects (Coherence +4)
- NPCs remember reasons, not just events
- Truth becomes possible to discuss
...
**How to resolve it**: The player must see *all* the versions without trying to reduce them to one. Holding multiplicity as stable. Or by finding the common thread through all versions—the essence that remains across all perspectives.

**When cleared**: The prismatic figure solidifies. One face steps forward from the many. But the others remain visible in the background, accepted as part of the whole.

### Post-Clear Effects (Coherence +5)
- NPCs can hold multiple truths at once
- Communities develop nuanced understanding
...
**How to resolve it**: The player must **remember** the figure. Acknowledging it. Calling it by name (if known). Grounding it in reality through attention and witness. Refusing to let it disappear.

**When cleared**: The figure solidifies and drops to the ground. Plants feet firmly. Exhales deeply. Becomes present again.

### Post-Clear Effects (Coherence +6)
- NPCs remember their own names, identities
- Communities have centers and hubs
...
**How to resolve it**: The player must break the loop. Act in a way that changes the pattern. Or must accept the cycle and find meaning in it anyway—transformation not as escape but as deeper understanding.

**When cleared**: The figure stops repeating. Takes a new step. Looks different. Changed. Evolved.

### Post-Clear Effects (Coherence +7)
- All chambers are cleared
- NPCs stand together as a community
- The world is fully restored
...
## How Chambers Transform After Clearing

When a glyph is cleared and coherence increases:

- **Visual**: Distortion overlay decreases, colors normalize, spaces become solid
- **Emotional**: The chamber becomes peaceful, almost meditative
- **Audio**: Dissonance resolves into harmony
...
## Integration: How NPCs Remember Domains

Each NPC should be attuned to one or more domains based on their role:

- **Korrin** (gatherer): Primarily Covenant
- **Mariel** (leader): Primarily Resolve
- **Sanor** (healer): Primarily Anchor
- **Tala** (builder): Primarily Accord
- **Veynar** (explorer): Primarily Ascendant
- **Ravi & Nima** (philosophers): Primarily Verity and Prism

As their domain is cleared, they gain specific memories and shift in dialogue.
