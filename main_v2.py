...
def render_main_app():
    ...
    # Header with logo and title in same flex container
    st.markdown("""
    <div style="display: flex; align-items: center; margin-bottom: 1rem;">
        <img src="graphics/FirstPerson-Logo.svg" style="height: 60px; width: auto; margin-right: 15px;" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline';">
        <span style="font-size: 3rem; margin-right: 15px; display: none;">🧠</span>
        <h1 style="margin: 0; color: #2E2E2E; font-weight: 300; letter-spacing: 2px; font-size: 2.5rem;">FirstPerson - Personal AI Companion</h1>
    </div>
    """, unsafe_allow_html=True)
