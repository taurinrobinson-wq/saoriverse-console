...
class Phase2Pruner:
    ...
    def extract_emotion_concepts(self, glyph_name: str) -> Set[str]:
        ...
        stop_words = {
            'of', 'in', 'through', 'within', 'with', 'the', 'a', 'an',
            'and', 'or', 'to', 'for', 'by', 'is', 'are', 'be',
            'sacred', 'divine', 'gentle', 'profound', 'ultimate',
            'moment', 'state', 'journey', 'flow', 'essence'
        }
    ...
    def save_pruning_results(self, new_glyphs: List[Dict], pruning_results: Dict, 
                             output_path: str, backup_path = None):
