...
def load_glyph_lexicon_from_csv(csv_path: str) -> dict:
    ...
    with open(csv_path, "r", encoding="utf-8") as f:
        ...
        for row in reader:
            ...
            glyphs[glyph_name] = {"voltage_pair": voltage_pair, "description": description, "gate": gate}
    return glyphs
    ...
    for glyph_name, mapping_data in glyph_mapping.items():
        ...
        for keyword in mapping_data["keywords"]:
            ...
            glyph_keywords[keyword].append(
                {"glyph": glyph_name, "gate": mapping_data["gate"], "voltage": mapping_data["voltage_pair"]}
            )
...
def main(
    csv_path: str = "glyph_lexicon_rows.csv",
