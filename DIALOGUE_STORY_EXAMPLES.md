...
All these scenes use the **same underlying system**:
1. Generate dialogue from current REMNANTS
2. Show player choices
3. Apply choice as TONE effect
4. Regenerate dialogue with new traits
5. Repeat until story beat complete
