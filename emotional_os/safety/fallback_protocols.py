...
class ToneAnalyzer:
    ...
    def __init__(self):
        ...
        self.voltage_keywords = {
            "struggle", "pain", "ache", "broken", "lost", "alone",
            "scared", "overwhelmed", "trapped", "dying", "dead", "numb",
            "worked", "well"  # Past tense/sarcasm indicators
        }
        self.sarcasm_markers = {
            "fine", "great", "perfect", "amazing", "wonderful", "yeah right",
            "sure", "obviously", "of course", "definitely", "absolutely"
        }
