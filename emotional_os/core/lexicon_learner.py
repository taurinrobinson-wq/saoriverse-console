...
from emotional_os.core.paths import (
    signal_lexicon_path, learned_lexicon_path, pattern_history_path
)
from emotional_os.core.constants import (
    EMOTIONAL_PATTERNS, THEME_KEYWORDS, SIGNAL_MAPPING, STOP_WORDS,
    EMPATHY_WORDS, REFLECTION_WORDS, MIN_EFFECTIVENESS_THRESHOLD,
...
class LexiconLearner:
    ...
    def __init__(self, base_lexicon_path: Optional[str] = None):
        if base_lexicon_path is None:
            base_lexicon_path = str(signal_lexicon_path())
        self.base_lexicon_path = base_lexicon_path
        self.learned_lexicon_path = str(learned_lexicon_path())
        self.pattern_history_path = str(pattern_history_path())
