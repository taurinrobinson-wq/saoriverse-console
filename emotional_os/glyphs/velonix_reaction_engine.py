    ...
    def _initialize_reactions(self) -> None:
        ...
        reactions_data = [
            ...
            ReactionChain(
                ...
                catalyst=None,
                result="Ac",
                trace_outcome="Wonder suspended in Stillness becomes Wisdom — "
            ...
            ReactionChain(
                ...
                catalyst=None,
                result="Ps",
                trace_outcome="Longing accepted (not rejected) becomes Presence — "
                             "desire integrated into the now"
            ),
        ]
