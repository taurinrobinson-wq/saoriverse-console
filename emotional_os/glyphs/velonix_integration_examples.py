...
from emotional_os.glyphs.velonix_visualizer import RitualPromptSystem, VelonixVisualizer
...
if __name__ == "__main__":
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["Full Interface", "Quick Widget", "Element Explorer", "Reaction Explorer"])
