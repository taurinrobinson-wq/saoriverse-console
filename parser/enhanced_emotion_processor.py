...
class EnhancedEmotionProcessor:
    ...
    def _extract_syntactic_elements(self, doc) -> Dict[str, List[str]]:
        ...
        emotional_verbs = {
            ...
            'anxious', 'worry', 'worrying', 'worried', 'fear', 'fearing', 'afraid', 'scared',
            'sad', 'sadden', 'saddening', 'grieve', 'grieving', 'grieved', 'mourn', 'mourning',
            'angry', 'anger', 'angering', 'frustrate', 'frustrating', 'frustrated', 'rage', 'raging',
            'happy', 'joy', 'joyful', 'delight', 'delighting', 'delighted', 'excited', 'excite',
            'love', 'loving', 'loved', 'hate', 'hating', 'hated', 'disgust', 'disgusting',
            'shame', 'shaming', 'ashamed', 'guilt', 'guilty', 'guilting', 'proud', 'pride',
        ...
        emotional_adjectives = {
            ...
            'frustrated', 'irritated', 'rageful', 'happy', 'joyful', 'delighted', 'excited', 'ecstatic',
            'loving', 'hateful', 'disgusted', 'ashamed', 'guilty', 'proud', 'hopeful', 'desperate',
            'trusting', 'doubtful', 'confused', 'clear', 'peaceful', 'calm', 'restless', 'tired',
    ...
    def enhance_gate_routing(self, existing_signals: List[Dict], text: str) -> Dict:
        ...
        enhanced_routing = {
            ...
            'routing_strategy': self._determine_routing_strategy(
                existing_signals, comprehensive_analysis
            )
        }
