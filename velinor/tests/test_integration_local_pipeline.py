...
def test_process_user_input_with_local_analysis():
    ...
    out = process_user_input(
        "I feel something shifting.", {"local_analysis": local_analysis, "emotion": "wonder", "intensity": "gentle"}
    )

    # Response should be inquisitive (short friend-like)
    assert ("tell me" in out.lower()) or ("what about" in out.lower()) or "opening" in out.lower()
