...
- **Verbal Cues**: Acknowledge their caution, don't push for information
- **Resonance Gates**: Certain glyphs (e.g., [Querrä] for inquiry) unlock deeper dialogue
...
- **Recent Event**: Series of thefts, raids, or community betrayal shook the marketplace
- **Current State**: Even welcoming NPCs now cautious; mistrusting NPCs more hostile
- **Visible Signs**: Locked containers, guards present, fewer open stalls, heightened voices
- **NPC Dialogue Theme**: "Too many hands have stolen"; "trust is a luxury we can't afford"

### Mechanical Impact
- Crime wave increases **initial friction** with all NPCs
- Creates opportunities for player to **investigate or ignore** crimes
- Solving crimes builds reputation faster than normal dialogue
- Can trigger **faction shifts**: helping victims earns trust; exploiting chaos loses it

### Optional Crime Arc
- **Investigation**: Player can ask NPCs about specific thefts
...
### Interconnection
- NPCs **talk to each other** about the player
- Helping one NPC can improve standing with their allies
- Mistrusting one NPC's ally can lower standing with related NPCs
...
**Dialogue is not extraction.** It's *attunement*. NPCs don't open up because player asked the right question — they open up because the player showed they actually care enough to listen.

This means:
- Player options should reflect **care and curiosity**, not tactics
- Empathy unlocks information faster than persuasion checks
- Listening is an active choice, not default behavior
