...
Ravi steps forward, less cautious. "Welcome. The Market District doesn't often receive travelers anymore. What brings you here?\"""",
    ...
    story.add_choice(
        from_passage_id="meet_ravi_nima",
        text="Step toward them openly",
        target_id="ravi_dialogue",
        tone_effects={"courage": 0.15, "narrative_presence": 0.1},
        npc_resonance={"Ravi": 0.2, "Nima": -0.05}
    )
    story.add_choice(
        from_passage_id="meet_ravi_nima",
        text="Keep distance and ask questions first",
        target_id="nima_dialogue",
        tone_effects={"wisdom": 0.15, "observation": 0.1},
        npc_resonance={"Ravi": -0.05, "Nima": 0.2}
    )
    story.add_choice(
        from_passage_id="meet_ravi_nima",
        text="Ask what they mean by 'resonance'",
        target_id="ravi_nima_resonance",
...
"What's your name, traveler?\"""",
    ...
    story.add_choice(
        from_passage_id="ravi_dialogue",
        text="Tell them your name",
        target_id="established_in_market",
        tone_effects={"empathy": 0.1},
        npc_resonance={"Ravi": 0.15, "Nima": 0.1}
    )
    story.add_choice(
        from_passage_id="ravi_dialogue",
        text="Ask them first who they were before the collapse",
        target_id="ravi_backstory",
...
Ravi adds, "The Market District used to be the heart of Velhara. Now it's just... ruins and waiting.\"""",
    ...
    story.add_choice(
        from_passage_id="nima_dialogue",
        text="Ask what they're looking for",
        target_id="nima_quest_reveal",
        tone_effects={"empathy": 0.15},
        npc_resonance={"Ravi": 0.05, "Nima": 0.2}
    )
    story.add_choice(
        from_passage_id="nima_dialogue",
        text="Ask about the resonance they mentioned",
        target_id="ravi_nima_resonance",
    ...
    story.add_passage(
        passage_id="ravi_nima_resonance",
...
Nima adds, more cautiously: "It also means the city will know you're here. That brings attention.\"""",
    ...
    story.add_choice(
        from_passage_id="ravi_nima_resonance",
    ...
    story.add_choice(
        from_passage_id="ravi_nima_resonance",
        text="Ask what kind of attention",
        target_id="nima_warning",
...
"He won't touch you if you can prove you're useful to him," Nima says. "But he's watching everyone new.\"""",
    ...
    story.add_choice(
        from_passage_id="nima_warning",
        text="Ask where you can find Kaelen",
        target_id="kaelen_location",
        tone_effects={"courage": 0.1, "narrative_presence": 0.15},
        npc_resonance={"Ravi": -0.1, "Nima": -0.05}
    )
    story.add_choice(
        from_passage_id="nima_warning",
        text="Ask if Ravi and Nima can help you",
        target_id="established_in_market",
        tone_effects={"empathy": 0.15},
...
The choice hangs in the market air between you.""",
    ...
    story.add_choice(
        from_passage_id="kaelen_location",
        text="Go to the Thieves' Cache now",
        target_id="thieves_cache_entrance",
        tone_effects={"courage": 0.2, "narrative_presence": 0.15},
        npc_resonance={"Ravi": -0.15, "Nima": -0.1}
    )
    story.add_choice(
        from_passage_id="kaelen_location",
        text="Ask Ravi and Nima to help you prepare",
        target_id="market_preparation",
    ...
    story.add_passage(
        passage_id="established_in_market",
...
The day is ending. The bioluminescent fungi grow brighter as the sun sets beyond the ruins.""",
    ...
    story.add_choice(
        from_passage_id="established_in_market",
        text="Go to the shelter and rest",
        target_id="marketplace_shelter",
        tone_effects={"empathy": 0.05},
        npc_resonance={"Ravi": 0.1, "Nima": 0.1}
    )
    story.add_choice(
        from_passage_id="established_in_market",
        text="Ask to visit the shrines before nightfall",
        target_id="shrine_visit_evening",
    ...
    story.add_passage(
        passage_id="marketplace_shelter",
...
[END OF PROTOTYPE - Act 2 to follow]""",
    ...
    story.add_passage(
        passage_id="shrine_visit_evening",
...
[PLACEHOLDER: Shrine encounter - Saori appears if resonance is high enough]""",
    ...
    story.add_passage(
        passage_id="thieves_cache_entrance",
