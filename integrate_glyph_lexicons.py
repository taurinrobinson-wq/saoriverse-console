...
if __name__ == "__main__":
    ...
    # Paths
    csv_path = "glyph_lexicon_rows.csv"
    signal_lexicon_path = "parser/signal_lexicon.json"
    output_signal_path = "parser/signal_lexicon.json"
    glyph_index_path = "parser/glyph_index.json"
