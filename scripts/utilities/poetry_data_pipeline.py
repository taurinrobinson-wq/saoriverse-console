...
class PoetryDataPipeline:
    ...
    POETRY_COLLECTIONS = {
        ...
        "yeats_poems": {"id": 6811, "poet": "W.B. Yeats", "period": "Modern", "description": "Collected Poems"},
        "shelley_complete": {
            "id": 4280,
    ...
    def process_collection(self, collection_name: str, collection_info: Dict) -> bool:
        ...
        self.hub.mark_validated(collection_name, completeness, details.get("usability_score", 0.9))
