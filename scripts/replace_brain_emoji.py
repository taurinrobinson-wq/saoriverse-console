...
SKIP_DIRS = {'.git', 'node_modules', '.venv', '.venv3',
             'venv', '__pycache__', 'dist', 'build', '.docker'}
SKIP_EXTS = {'.png', '.jpg', '.jpeg', '.gif', '.svg', '.ico', '.woff', '.woff2', '.ttf', '.otf', '.db',
             '.bin', '.zip', '.gz', '.tar', '.tgz', '.mp4', '.mp3', '.mov', '.exe', '.dll', '.so', '.pyc', '.ipynb'}
...
def main():
    ...
    ap.add_argument('--dry-run', action='store_true',
                    help='Don\'t write files; just list candidates')
