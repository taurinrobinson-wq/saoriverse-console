...
def demo_dynamic_glyph_evolution():
    ...
    try:
        ...
        user_input_2 = "You're right. When I'm with them, the fear turns into something beautiful—like I'm becoming more myself."
        ai_response_2 = (
        ...
        user_input_3 = "There's something sacred about being known. About letting my walls down. It feels like coming home."
        ai_response_3 = (
        ...
        print(f"All signals found: {len(set([s.get('signal') or s.get('name') for s in conv_summary.get('all_signals', []) if s]))}")
