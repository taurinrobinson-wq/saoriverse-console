...
class ImageGenerationAPI:
    ...
    def generate_dalle_image(
        self, prompt: str, model: str = "dall-e-3", size: str = "1024x1024", quality: str = "standard"
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.openai_client.images.generate(model=model, prompt=prompt, size=size, quality=quality, n=1)
    ...
    def generate_stable_diffusion_image(self, prompt: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"success": True, "image_data": image_data, "prompt": prompt, "model": "stable-diffusion-xl"}
    ...
    def generate_replicate_image(self, prompt: str, model: str = "controlnet") -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": "Replicate integration coming soon"}
        ...
        with tab1:
            ...
            if st.button("🎨 Generate DALL-E Image", type="primary"):
                with st.spinner("Generating image..."):
                    result = self.image_api.generate_dalle_image(dalle_prompt, dalle_model, dalle_size, dalle_quality)
            ...
            if st.button("🎨 Generate Stable Diffusion Image"):
                with st.spinner("Generating with Stable Diffusion..."):
                    result = self.image_api.generate_stable_diffusion_image(
                        sd_prompt, steps=sd_steps, guidance_scale=sd_guidance, width=sd_width, height=sd_height
                    )
    ...
    def render_document_testing(self):
        ...
        with tab2:
            ...
            template_format = st.selectbox(
                "Document Format", ["Emotional Report", "Glyph Analysis", "User Summary", "Progress Report"]
            )
        ...
        with tab3:
            ...
            export_format = st.selectbox(
                "Export Type", ["User Analytics", "Glyph Matrices", "Conversation Logs", "System Reports"]
            )
...
def main():
    ...
    st.set_page_config(page_title="FirstPerson API Testing", page_icon="🔌", layout="wide")
