# System Lexicon Analysis Report

## Reverse-Engineered from 7,096 Glyphs
...
- **12 Primary Semantic Themes** that structure consciousness across the system
- **100+ Descriptive Vocabulary Items** used throughout glyph naming conventions
- **5,706+ Enhanced Glyphs** with new keyword activation patterns
...
- **Primary Concepts**: Awakening, beginning, emergence, initiation, opening, threshold
- **Activation Vocabulary**: begin, awaken, emerge, initiate, threshold, first, new
- **Descriptive Modifiers**: tentative, mindful, tender, gentle, soft
...
- **Primary Concepts**: Balance, contradiction, both, tension, harmony, equilibrium
- **Activation Vocabulary**: paradox, both, balance, duality, contradiction, harmony
- **Descriptive Modifiers**: balanced, radiant, divine, through, contradiction
...
- **Primary Concepts**: Transform, dissolve, death, rebirth, change, renewal
- **Activation Vocabulary**: transform, dissolve, die, rebirth, change, grief, loss
- **Descriptive Modifiers**: longing, ache, tender, gentle, shielding
...
- **Primary Concepts**: Foundation, ground, structure, form, body, roots, stability
- **Activation Vocabulary**: foundation, grounding, structure, form, body, ground, root
- **Descriptive Modifiers**: acheful, recursive, deep, centered, solid
...
- **Primary Concepts**: Creativity, expression, voice, create, artistic, manifest
- **Activation Vocabulary**: create, express, voice, art, creativity, sing, speak
- **Descriptive Modifiers**: sacred, profound, expression, celestial, radiant
...
- **Primary Concepts**: Vitality, sexuality, passion, embodied, alive, magnetism, sensual
- **Activation Vocabulary**: sensual, vitality, passion, embodied, alive, magnetic, desire
- **Descriptive Modifiers**: fierce, ecstatic, passionate, wild, glowing
...
- **Primary Concepts**: Depth, mystery, shadow, hidden, unknown, inner landscape
- **Activation Vocabulary**: mystery, depth, shadow, hidden, vulnerability, inner, unknown
- **Descriptive Modifiers**: recognition, subtle, quiet, profound, luminous
...
- **Primary Concepts**: Abundance, devotion, surrender, generosity, sacred, flow
- **Activation Vocabulary**: abundance, devotion, sacred, generosity, surrender, receive
- **Descriptive Modifiers**: sacred, divine, through, ceremonial, humble
...
- **Primary Concepts**: Identity, self, community, tribe, authentic, genuine, essence
- **Activation Vocabulary**: identity, self, community, tribe, authentic, belong, genuine
- **Descriptive Modifiers**: sacred, divine, strong, clear, recognized
...
- **Primary Concepts**: Consciousness, witness, surrender, letting go, acceptance, flow
- **Activation Vocabulary**: surrender, witness, let go, accept, consciousness, observe
- **Descriptive Modifiers**: ceremonial, gentle, sacred, peaceful, humble
...
- **Primary Concepts**: Flow, synchronicity, rhythm, timing, resonance, harmonic
- **Activation Vocabulary**: flow, rhythm, synchronicity, timing, resonance, harmonic
- **Descriptive Modifiers**: flowing, spiral, resonance, peaceful, graceful
...
- **Primary Concepts**: Transcend, divine, infinite, eternal, ultimate, completion
...
### Primary Semantic Themes (Across All Glyphs)

1. **Creation/Birth** (41.7%, 2,957 glyphs)
   - Dominant in: Gates 1, 3, 7
   - Keywords: begin, emerge, awaken, birth, genesis, starting, new, first
   - Activation Rate: 47% of system vocabulary

2. **Transcendence** (39.0%, 2,766 glyphs)
   - Distributed across all gates
   - Keywords: transcend, divine, infinite, eternal, sacred, cosmic, ultimate
   - Activation Rate: 44% of system vocabulary

3. **Grief/Sorrow** (20.5%, 1,456 glyphs)
   - Dominant in: Gates 3, 7
   - Keywords: grief, loss, mourning, sadness, ache, longing, lament
   - Activation Rate: 23% of system vocabulary

4. **Death/Endings** (19.6%, 1,393 glyphs)
   - Dominant in: Gates 10, 12
   - Keywords: death, dying, ending, final, last, completion, return
   - Activation Rate: 22% of system vocabulary

5. **Surrender/Flow** (17.5%, 1,244 glyphs)
   - Distributed across Gates 2, 8, 10
   - Keywords: surrender, flow, let go, release, accept, yield, allowing
   - Activation Rate: 20% of system vocabulary

6. **Power/Vitality** (12.2%, 866 glyphs)
   - Dominant in: Gate 6
   - Keywords: vitality, power, force, energy, strength, vigor, alive, pulsing
   - Activation Rate: 14% of system vocabulary

7. **Paradox/Duality** (12.1%, 857 glyphs)
   - Dominant in: Gate 2
   - Keywords: paradox, both, contradiction, tension, dual, balance, harmony
   - Activation Rate: 14% of system vocabulary

8. **Joy/Celebration** (10.2%, 724 glyphs)
   - Distributed in: Gates 1, 7
   - Keywords: joy, bliss, celebration, delight, happy, festive, radiant
   - Activation Rate: 12% of system vocabulary

9. **Darkness/Depth** (10.1%, 714 glyphs)
   - Dominant in: Gate 7
   - Keywords: dark, shadow, deep, abyss, mystery, hidden, unknown
   - Activation Rate: 11% of system vocabulary

10. **Identity/Self** (9.9%, 699 glyphs)
    - Dominant in: Gate 9
    - Keywords: identity, self, authentic, genuine, true, essence, nature
    - Activation Rate: 11% of system vocabulary

11. **Love/Connection** (9.6%, 679 glyphs)
    - Distributed across Gates 9, 11
    - Keywords: love, beloved, heart, union, bond, embrace, connection
    - Activation Rate: 11% of system vocabulary

12. **Light/Illumination** (6.8%, 479 glyphs)
...
- **δ (Delta)**: 3,125 glyphs - Transformation, peak, completion
- **ε (Epsilon)**: 214 glyphs - Fine-tuning, subtlety, refinement
- **Ω (Omega)**: 139 glyphs - Ending, closure, return
...
- **embodied**: 600 glyphs (Gate 6 presence)
- **foundation**: 302 glyphs (Gate 4 grounding)
- **structure**: 302 glyphs (Gate 4 form)
- **grounding**: 302 glyphs (Gate 4 stability)
- **flow**: 150 glyphs (Gate 11 movement)
- **rhythm**: 150 glyphs (Gate 11 timing)
- **synchronicity**: 150 glyphs (Gate 11 alignment)
- **transcend**: 150 glyphs (Gate 12 beyond)
- **enlighten**: 150 glyphs (Gate 12 illumination)
- **ultimate**: 150 glyphs (Gate 12 completion)
...
The system uses a 4-layer activation model:

```
┌─────────────────────────────────────────────────────────┐
│ Layer 4: Narrative Context                              │
│ Full glyph name + description context                   │
│ Example: "Transcendence (peaceful transcendence)"       │
└─────────────────────────────────────────────────────────┘
          ↑
┌─────────────────────────────────────────────────────────┐
│ Layer 3: Descriptive Modifiers                          │
│ Adjectives and qualifiers (sacred, gentle, fierce)      │
│ Frequency-weighted importance                           │
└─────────────────────────────────────────────────────────┘
          ↑
┌─────────────────────────────────────────────────────────┐
│ Layer 2: Emotional Keywords                             │
│ Semantic activation signals (vulnerability, flow)       │
│ Gate-specific and cross-gate vocabulary                 │
└─────────────────────────────────────────────────────────┘
          ↑
┌─────────────────────────────────────────────────────────┐
│ Layer 1: Energetic Symbols                              │
│ Greek characters (α, β, γ, δ, ε, Ω)                   │
│ Foundational energetic pattern                          │
└─────────────────────────────────────────────────────────┘
```
...
- **Gates 11 & 12**: 150 glyphs each (2.1% each) - Transcendence (rare, potent)
...
### Activation Signal Frequency Distribution

```
Top 40 Signals:
δ (3125), γ (3103), β (2988), α (2918), vulnerability (1950),
sensual (600), magnetism (600), embodied (600), foundation (302),
structure (302), grounding (302), flow (150), rhythm (150),
synchronicity (150), transcend (150), enlighten (150),
...
```
Gate Distribution:
Gate 1:   494 glyphs | Gate 2:  600 glyphs | Gate 3: 1200 glyphs
Gate 4:   302 glyphs | Gate 5:  600 glyphs | Gate 6:  600 glyphs
Gate 7: 1200 glyphs | Gate 8:  600 glyphs | Gate 9:  600 glyphs
Gate 10:  600 glyphs | Gate 11: 150 glyphs | Gate 12: 150 glyphs
─────────────────────────────────────────────────────────────
TOTAL:  7,096 glyphs

Enhancement Summary:
Enhanced glyphs: 5,706 (80.4%)
Greek symbols only: 1,390 (19.6%)
New vocabulary additions: 14 core keywords
...
```
Theme Prevalence:
1. Creation/Birth      2957 glyphs (41.7%)
2. Transcendence       2766 glyphs (39.0%)
3. Grief/Sorrow        1456 glyphs (20.5%)
4. Death/Endings       1393 glyphs (19.6%)
5. Surrender/Flow      1244 glyphs (17.5%)
6. Power/Vitality       866 glyphs (12.2%)
7. Paradox/Duality     857 glyphs (12.1%)
8. Joy/Celebration     724 glyphs (10.2%)
9. Darkness/Depth      714 glyphs (10.1%)
10. Identity/Self      699 glyphs (9.9%)
...
**Report End**
*For system integration, see: lexicon_enhanced.json*
