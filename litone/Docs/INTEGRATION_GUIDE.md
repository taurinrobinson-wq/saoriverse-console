...
Analysis Composer** - Contextual tone analysis and transformation guidance 3. **Lightweight Tone
Signal Parser** - Lightweight signal detection without database 4. **Legal Constants** - Tone
signals, patterns, and legal-specific markers
